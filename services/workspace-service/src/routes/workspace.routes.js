...
const {
    ...
    addMember,removeMember,deleteWorkspace, setUserPermission, getWorkspaceTrash} = require('../controllers/workspace.controller');
...
router.get('/:id/trash',                            getWorkspaceTrash);
