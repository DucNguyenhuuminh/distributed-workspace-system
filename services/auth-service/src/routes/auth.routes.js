...
const {register, login, getProfile,findByEmail,forgotPassword, changePassword, resetPassword,findById} = require('../controllers/auth.controller');
...
router.get('/internal/find-by-id',          findById);
